...
interface
   ...
   type
    Antrian = class
      ...
      procedure susunFilePoli(str0 : string);
      public
      procedure mainkan;
      constructor create(antri : Integer; loket : Integer; poli : string);
      destructor destroy;
    end;
implementation
...
constructor Antrian.create(antri, loket: Integer; poli : string);
begin
  inherited create();
  fAntri := antri;
  fLoket := loket;
...
procedure Antrian.susunFilePoli(str0: string);
begin
suaraFile.Add('poli.wav');
suaraFile.Add( str0+ '.wav')
//if str0 = 'imunisasi' then suaraFile.Add('imunisasi.wav') else
{
if str0 = 'gigi' then suaraFile.Add('gigi.wav') else
if str0 = 'kb' then suaraFile.Add('kb.wav') else
if str0 = 'mata' then suaraFile.Add('mata.wav') else
if str0 = 'kia' then suaraFile.Add('kia.wav') else suaraFile.Add('umum.wav');
 }
